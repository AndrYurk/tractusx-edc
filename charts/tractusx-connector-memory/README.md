...
![Version: 0.21.0-rc4](https://img.shields.io/badge/Version-0.21.0--rc4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.21.0-rc4](https://img.shields.io/badge/AppVersion-0.21.0--rc4-informational?style=flat-square)
...
helm install my-release tractusx-edc/tractusx-connector-memory --version 0.21.0-rc4 \
